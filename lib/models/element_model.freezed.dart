...
mixin _$ElementModel {
  ...
  List<List<List<ElementModel>>> get gridChildren =>
    ...
    return _then(_value.copyWith(
      ...
      gridChildren: null == gridChildren
          ...
          : gridChildren // ignore: cast_nullable_to_non_nullable
              as List<List<List<ElementModel>>>,
...
class _$ElementModelImpl extends _ElementModel {
  const _$ElementModelImpl(
      ...
      final List<List<List<ElementModel>>> gridChildren = const [],
      this.columnCount,
      this.rowCount})
  ...
  final List<List<List<ElementModel>>> _gridChildren;
  @override
  @JsonKey()
  List<List<List<ElementModel>>> get gridChildren {
    if (_gridChildren is EqualUnmodifiableListView) return _gridChildren;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_gridChildren);
  }
  ...
  @override
  String toString() {
    return 'ElementModel(id: $id, title: $title, description: $description, type: $type, layoutType: $layoutType, gridChildren: $gridChildren, columnCount: $columnCount, rowCount: $rowCount)';
  }
